...
class ForgeryDetectorEngine:
    ...
    def analyze_prediction(self, df, original_labels):
        ...
        return results, success_failure
...
if __name__ == "__main__":
    ...
    print(predicted_data[['name', 'label']].head())



    results, success_failure = detector_engine.analyze_prediction(predicted_data, original_labels)
    ...
    y_test = df_test_melted['label'].values

    fpr, tpr, _ = roc_curve(y_test, predicted_data['label'])
    roc_auc = auc(fpr, tpr)
